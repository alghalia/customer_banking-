...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate (as a percentage) for the savings account: "))
    savings_maturity = int(input("Enter the length in months for the savings account: "))
    ...
    cd_interest = float(input("Enter the annual interest rate (as a percentage) for the CD account: "))
    cd_maturity = int(input("Enter the length in months for the CD account: "))
